...
{
	if (region.p.cT === region.m.cT)
	{
		return 'on line ' + region.p.cT;
	}
	return 'on lines ' + region.p.cT + ' through ' + region.m.cT;
}
									...
									return A2(
										...
										function (body) {
											return $elm$json$Json$Decode$succeed(
												{hX: body, gi: jsResponseHandler, gq: method, dJ: processes, ht: url});
										},
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$string(
					$author$project$Data$Process$idToString(v.fW.H))),
				_Utils_Tuple2(
				'heatProcessUuid',
				$elm$json$Json$Encode$string(
					$author$project$Data$Process$idToString(v.f5.H))),
				_Utils_Tuple2(
				'name',
		...
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Volume$inCubicMeters(v.kA)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				'amount',
				$elm$json$Json$Encode$float(
					$author$project$Data$Component$amountToFloat(element.aP))),
				_Utils_Tuple2(
				'material',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'pcrWaste',
				$author$project$Data$Split$encodeFloat(v.gF)),
				_Utils_Tuple2(
				'complexity',
				$elm$json$Json$Encode$string(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'defaultNbCycles',
				$elm$json$Json$Encode$int(v.fP)),
				_Utils_Tuple2(
				'ratioDryer',
				$author$project$Data$Split$encodeFloat(v.gR)),
				_Utils_Tuple2(
				'ratioIroning',
				...
				'timeIroning',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Duration$inHours(v.hk))),
				_Utils_Tuple2(
				'daysOfWear',
				$elm$json$Json$Encode$float(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'fabric',
				$author$project$Data$Textile$Fabric$encode(v.fZ)),
				_Utils_Tuple2(
				'making',
				$author$project$Data$Textile$Product$encodeMakingOptions(v.eI)),
				_Utils_Tuple2(
				'trims',
				A2($elm$json$Json$Encode$list, $author$project$Data$Component$encodeItem, v.ku)),
				_Utils_Tuple2(
				'use',
				$author$project$Data$Textile$Product$encodeUseOptions(v.hu)),
				_Utils_Tuple2(
				'endOfLife',
				$author$project$Data$Textile$Product$encodeEndOfLifeOptions(v.iy))
			]));
};
...
var $author$project$Data$Textile$Material$Origin$toString = function (origin) {
	switch (origin) {
		case 0:
			return 'ArtificialFromInorganic';
		case 1:
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				'origin',
				$elm$json$Json$Encode$string(
					$author$project$Data$Textile$Material$Origin$toString(v.gC))),
				_Utils_Tuple2(
				'materialProcessUuid',
				$author$project$Data$Process$encodeId(v.gp.H)),
				_Utils_Tuple2(
				'recycledProcessUuid',
				A2(
				...
				_Utils_Tuple2(
				'geographicOrigin',
				$elm$json$Json$Encode$string(v.iJ)),
				_Utils_Tuple2(
				'defaultCountry',
				$elm$json$Json$Encode$string(
					$author$project$Data$Country$codeToString(v.fN)))
			]));
};
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $author$project$Data$Textile$Economics$encodeBusiness, inputs.fB))),
				_Utils_Tuple2(
				'countryDyeing',
				$author$project$Data$Country$encode(inputs.aV)),
				_Utils_Tuple2(
				'countryFabric',
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$int, inputs.gA))),
				_Utils_Tuple2(
				'physicalDurability',
				A2(
					$elm$core$Maybe$withDefault,
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $author$project$Data$Textile$Economics$encodePrice, inputs.gL))),
				_Utils_Tuple2(
				'printing',
				A2(
					$elm$core$Maybe$withDefault,
				...
				_Utils_Tuple2(
				'product',
				$author$project$Data$Textile$Product$encode(inputs.a2)),
				_Utils_Tuple2(
				'surfaceMass',
				A2(
					$elm$core$Maybe$withDefault,
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$bool, inputs.hm))),
				_Utils_Tuple2(
				'upcycled',
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $author$project$Data$Unit$encodeYarnSize, inputs.kE)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'sea',
				$author$project$Data$Transport$encodeKm(v.g3)),
				_Utils_Tuple2(
				'seaCooled',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'cropDiversity',
				$author$project$Data$Unit$encodeImpact(negated.dk)),
				_Utils_Tuple2(
				'hedges',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'endOfLife',
				encodeMaybeString(v.iy)),
				_Utils_Tuple2(
				'fabric',
				encodeMaybeString(v.fZ)),
				_Utils_Tuple2(
				'fading',
...
var $author$project$Data$Impact$getTotalComplementsImpacts = function (complementsImpacts) {
	return $ianmackenzie$elm_units$Quantity$sum(
		_List_fromArray(
			[complementsImpacts.dk, complementsImpacts.du, complementsImpacts.dz, complementsImpacts.jf, complementsImpacts.jD, complementsImpacts.dG, complementsImpacts.dH]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'complementsImpacts',
				$author$project$Data$Impact$encodeComplementsImpacts(v.h3)),
				_Utils_Tuple2(
				'country',
				$author$project$Data$Country$encode(v.fK)),
				_Utils_Tuple2(
				'deadstock',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Mass$inKilograms(v.h9))),
				_Utils_Tuple2(
				'durability',
				$author$project$Data$Unit$encodeNonPhysicalDurability(v.aj)),
				_Utils_Tuple2(
				'editable',
				$elm$json$Json$Encode$bool(v.iv)),
				_Utils_Tuple2(
				'elecKWh',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Energy$inKilowattHours(v.ax))),
				...
				$author$project$Data$Impact$encode(
					A2(
						...
						$author$project$Data$Impact$getTotalComplementsImpacts(v.h3),
						v.z))),
				_Utils_Tuple2(
				'inputMass',
				$elm$json$Json$Encode$float(
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $author$project$Data$Unit$encodePickPerMeter, v.gG))),
				_Utils_Tuple2(
				'preTreatments',
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $author$project$Data$Unit$encodeThreadDensity, v.hj))),
				_Utils_Tuple2(
				'transport',
				$author$project$Data$Transport$encode(v.c6)),
				_Utils_Tuple2(
				'waste',
				$elm$json$Json$Encode$float(
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $author$project$Data$Unit$encodeYarnSize, v.kE)))
			]));
};
...
var $author$project$Data$Impact$addComplementsImpacts = F2(
	function (a, b) {
		return {
			dk: A2($ianmackenzie$elm_units$Quantity$plus, a.dk, b.dk),
...
var $author$project$Data$Impact$noComplementsImpacts = {dk: $author$project$Data$Unit$noImpacts, du: $author$project$Data$Unit$noImpacts, dz: $author$project$Data$Unit$noImpacts, jf: $author$project$Data$Unit$noImpacts, jD: $author$project$Data$Unit$noImpacts, dG: $author$project$Data$Unit$noImpacts, dH: $author$project$Data$Unit$noImpacts};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				'defaultOrigin',
				$elm$json$Json$Encode$string(
					$author$project$Data$Food$Origin$toLabel(ingredient.fQ)))
			]));
};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {iI: fragment, iO: host, gE: path, jJ: port_, jQ: protocol, dK: query};
	});
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.gE),
...
var $author$project$Data$Food$Query$Query = F5(
	function (distribution, ingredients, packaging, preparation, transform) {
		return {cO: distribution, iS: ingredients, bB: packaging, aK: preparation, bQ: transform};
	});
...
var $author$project$Data$Food$Retail$ambient = A2(
	...
	0,
	{
		...
		b9: A2(
			...
			$ianmackenzie$elm_units$Volume$cubicMeters(1)),
		c6: $ianmackenzie$elm_units$Length$kilometers(600),
		bV: A2(
...
var $author$project$Data$Food$Query$IngredientQuery = F4(
	function (country, id, mass, planeTransport) {
		return {fK: country, H: id, T: mass, gI: planeTransport};
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {d: index, cV: match, jv: number, kg: submatches};
	});
...
var $author$project$Data$Food$Validation$validateIngredient = F2(
	function (db, ingredientQuery) {
		return A2(
			...
			$elm$core$Result$Ok(ingredientQuery.gI),
			A2(
				$elm_community$result_extra$Result$Extra$andMap,
				...
				A2(
					...
					A2(
						...
						A2($author$project$Data$Food$Ingredient$findById, ingredientQuery.H, db.cS.iS)),
					A2(
						$elm_community$result_extra$Result$Extra$andMap,
						A2(
							$author$project$Data$Food$Validation$validateMaybe,
							A2($author$project$Data$Country$validateForScope, 0, db.h5),
							ingredientQuery.fK),
																		...
																		return function (printing) {
																			return function (product) {
																				return function (surfaceMass) {
																					return function (traceability) {
																						return function (trims) {
																							return function (upcycled) {
																								return function (yarnSize) {
																									return {bY: airTransportRatio, fB: business, aV: countryDyeing, bb: countryFabric, bc: countryMaking, b4: countrySpinning, b6: disabledSteps, b7: dyeingProcessType, bj: fabricProcess, cb: fading, i9: makingComplexity, cl: makingDeadStock, cm: makingWaste, T: mass, jc: materials, gA: numberOfReferences, co: physicalDurability, gL: price, cp: printing, a2: product, e5: surfaceMass, hm: traceability, ku: trims, cz: upcycled, kE: yarnSize};
																								};
																							};
																						};
																					};
...
var $author$project$Data$Split$fromFloat = function (_float) {
	return ((_float < 0) || (_float > 1)) ? $elm$core$Result$Err(
		'Une part (en nombre flottant) doit être comprise entre 0 et 1 inclus (ici: ' + ($elm$core$String$fromFloat(_float) + ')')) : $elm$core$Result$Ok(100 * _float);
};
...
var $author$project$Data$Component$Element = F3(
	function (amount, material, transforms) {
		return {aP: amount, aa: material, au: transforms};
	});
...
var $author$project$Data$Textile$Query$MaterialQuery = F4(
	function (country, id, share, spinning) {
		return {fK: country, H: id, ac: share, cu: spinning};
	});
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2($author$project$Data$Country$validateForScope, 2, db.h5),
							materialQuery.fK),
		...
		return A4(
			...
			A3(
				...
				A4(
					...
					'trims',
					query.ku,
					$author$project$Data$Component$validateItem(db.dj),
					A3(
						$author$project$Data$Validation$check,
						'traceability',
						$elm$core$Result$Ok(query.hm),
						A4(
							$author$project$Data$Validation$maybe,
							'surfaceMass',
							query.e5,
							...
							A3(
								$author$project$Data$Validation$check,
								'product',
								A2($author$project$Data$Textile$Validation$validateProduct, db, query.a2),
								A3(
									$author$project$Data$Validation$ok,
									'printing',
									query.cp,
		...
		return $author$project$Data$Impact$sumImpacts(
			_List_fromArray(
				[
					...
					A3($author$project$Data$Food$Retail$elecImpact, needs.b2, volume, wellknown.i8),
					A3($author$project$Data$Food$Retail$elecImpact, needs.b9, volume, wellknown.i8)
				]));
	});
	...
	function (_v0, mass, transport) {
		...
		var transportImpacts = $author$project$Data$Impact$sumImpacts(
			A2(
				...
				_List_fromArray(
					[
						_Utils_Tuple2(wellKnown.i7, transport.dP),
						_Utils_Tuple2(wellKnown.i6, transport.j2),
						_Utils_Tuple2(wellKnown.hW, transport.g3),
						_Utils_Tuple2(wellKnown.hV, transport.j7),
						_Utils_Tuple2(wellKnown.gI, transport.hK)
					])));
		return _Utils_update(
			transport,
			{z: transportImpacts});
...
var $author$project$Data$Transport$default = function (impacts) {
	return {hK: $ianmackenzie$elm_units$Quantity$zero, z: impacts, dP: $ianmackenzie$elm_units$Quantity$zero, j2: $ianmackenzie$elm_units$Quantity$zero, g3: $ianmackenzie$elm_units$Quantity$zero, j7: $ianmackenzie$elm_units$Quantity$zero};
};
		...
		switch (origin) {
			...
			case 2:
				return _Utils_update(
					...
					{
						dP: $ianmackenzie$elm_units$Length$kilometers(2500),
						g3: $ianmackenzie$elm_units$Length$kilometers(18000)
					});
			default:
...
var $author$project$Data$Transport$erroneous = function (impacts) {
	return {hK: $ianmackenzie$elm_units$Quantity$infinity, z: impacts, dP: $ianmackenzie$elm_units$Quantity$infinity, j2: $ianmackenzie$elm_units$Quantity$infinity, g3: $ianmackenzie$elm_units$Quantity$infinity, j7: $ianmackenzie$elm_units$Quantity$infinity};
};
			...
			var base = function () {
				if (!country.$) {
					...
					return A2(
						...
						planeRatio,
						A4($author$project$Data$Transport$getTransportBetween, emptyImpacts, code, $author$project$Data$Food$Recipe$france, db.ii));
				} else {
					return A2($author$project$Data$Food$Ingredient$getDefaultOriginTransport, planeTransport, ingredient.fQ);
				}
			}();
			return (ingredient.kr !== 2) ? _Utils_update(
				base,
				{dP: $ianmackenzie$elm_units$Quantity$zero, j2: base.dP, g3: $ianmackenzie$elm_units$Quantity$zero, j7: base.g3}) : base;
		}();
		var transport = toLogistics(
			toTransformation(baseTransport));
		return A3($author$project$Data$Transport$computeImpacts, db.cS, mass, transport);
	});
...
var $author$project$Data$Food$EcosystemicServices$coefficients = {
	dk: $author$project$Data$Unit$ratio(1.5),
...
var $author$project$Data$Food$Recipe$computeIngredientComplementsImpacts = F2(
	function (_v0, ingredientMass) {
		...
		return {
			dk: A2(apply, $author$project$Data$Food$EcosystemicServices$coefficients.dk, cropDiversity),
	...
	F2(
		function (_v0, acc) {
			...
			return A2(
				...
				acc,
				A2($author$project$Data$Food$Recipe$computeIngredientComplementsImpacts, ingredient.it, mass));
		}),
...
var $author$project$Data$Food$Recipe$RecipeIngredient = F4(
	function (country, ingredient, mass, planeTransport) {
		return {fK: country, aw: ingredient, T: mass, gI: planeTransport};
	});
...
var $author$project$Data$Food$Recipe$ingredientFromQuery = F2(
	function (db, _v0) {
		...
		var mass = _v0.T;
		var planeTransport = _v0.gI;
		var ingredientResult = A2($author$project$Data$Food$Ingredient$findById, id, db.cS.iS);
		return A2(
			$elm_community$result_extra$Result$Extra$andMap,
			A2(
				$elm$core$Result$andThen,
					...
					A2(
						...
						function () {
							var _v1 = A2(
								$elm$core$Maybe$map,
								function (c) {
									return A2($author$project$Data$Country$findByCode, c, db.h5);
								},
								country);
							if (!_v1.$) {
								if (!_v1.a.$) {
...
var $author$project$Data$Food$Recipe$isCookedAtPlant = function (transform) {
	var _v0 = A2(
		$elm$core$Maybe$map,
		A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				$author$project$Data$Process$idToString)),
		transform);
	if ((!_v0.$) && (_v0.a === '83b897cf-9ed2-5604-83b4-67fab8606d35')) {
		return true;
	} else {
		return false;
	}
	...
	function (recipeIngredient) {
		...
		return _Utils_update(
			recipeIngredient,
			{
				T: A2(
					$ianmackenzie$elm_units$Quantity$multiplyBy,
					1 - $author$project$Data$Split$toFloat(ingredient.iR),
					mass)
			});
	});
var $author$project$Data$Food$Recipe$getTransformedIngredientsMass = function (_v0) {
	var ingredients = _v0.iS;
	...
	return $ianmackenzie$elm_units$Quantity$sum(
		A2(
			...
			function (_v1) {
				...
				var mass = _v1.T;
				return $author$project$Data$Food$Recipe$isCookedAtPlant(transform) ? A2(
					$ianmackenzie$elm_units$Quantity$multiplyBy,
...
var $author$project$Data$Food$Recipe$getMassAtPackaging = function (recipe) {
	return $ianmackenzie$elm_units$Quantity$sum(
		_List_fromArray(
			[
				$author$project$Data$Food$Recipe$getTransformedIngredientsMass(recipe),
				$author$project$Data$Food$Recipe$getPackagingMass(recipe)
			]));
};
var $elm$core$Basics$not = _Basics_not;
var $author$project$Data$Food$Recipe$getPreparedMassAtConsumer = function (recipe) {
	var ingredients = recipe.iS;
	var transform = recipe.bQ;
	var preparation = recipe.aK;
	var cookedAtConsumer = A2(
		...
		preparation);
	return ((!$author$project$Data$Food$Recipe$isCookedAtPlant(transform)) && cookedAtConsumer) ? $ianmackenzie$elm_units$Quantity$sum(
		A2(
			$elm$core$List$map,
			function (_v0) {
				var ingredient = _v0.aw;
			...
			ingredients)) : $author$project$Data$Food$Recipe$getTransformedIngredientsMass(recipe);
};
...
var $author$project$Data$Food$Recipe$getTransformedIngredientsDensity = function (_v0) {
	...
	if (ingredients.b && (!ingredients.b.b)) {
		var i = ingredients.a;
		return (!_Utils_eq(transform, $elm$core$Maybe$Nothing)) ? $ianmackenzie$elm_units$Density$gramsPerCubicCentimeter(1) : i.aw.$8;
	} else {
		return $ianmackenzie$elm_units$Density$gramsPerCubicCentimeter(1);
	}
};
var $author$project$Data$Food$Recipe$getTransformedIngredientsVolume = function (recipe) {
	return A2(
		...
		function (_v0, acc) {
			...
			return _Utils_update(
				acc,
				{
					...
					g3: A2($ianmackenzie$elm_units$Quantity$plus, sea, acc.g3),
	...
	return A2(
		...
		$elm$core$Result$map(
			function (recipe) {
				...
				var preparation = recipe.aK;
				var transformedIngredientsMass = $author$project$Data$Food$Recipe$getTransformedIngredientsMass(recipe);
				...
				var preparedMass = $author$project$Data$Food$Recipe$getPreparedMassAtConsumer(recipe);
				...
				var preparationImpacts = $author$project$Data$Impact$sumImpacts(
					A2(
						$elm$core$List$map,
						A2($author$project$Data$Food$Preparation$apply, db.cS.kC, transformedIngredientsMass),
						preparation));
				...
				var distributionTransport = function () {
					var transport = A2(
						...
						A2(
							...
							distribution));
					var mass = $author$project$Data$Food$Recipe$getMassAtPackaging(recipe);
					return A3($author$project$Data$Transport$computeImpacts, db.cS, mass, transport);
				}();
				var distributionImpacts = A2(
					...
					A2(
						$elm$core$Maybe$map,
						function (distrib) {
							var volume = $author$project$Data$Food$Recipe$getTransformedIngredientsVolume(recipe);
							return A3($author$project$Data$Food$Retail$computeImpacts, volume, distrib, db.cS.kC);
						},
						distribution));
				...
				return _Utils_Tuple2(
					recipe,
					{
						cO: {a3: distributionImpacts, aO: distributionTransport},
						bB: packagingImpacts,
						eS: impactsPerKg,
						aK: preparationImpacts,
						eU: preparedMass,
						aL: {
							iu: $ianmackenzie$elm_units$Quantity$sum(
								A2(
									$elm$core$List$map,
									function ($) {
										return $.T;
									},
									$author$project$Data$Food$Recipe$removeIngredientsInedibleMass(recipe.iS))),
							iS: ingredientsImpacts,
							...
							hl: totalComplementsImpact,
							ko: totalComplementsImpactPerKg,
							bQ: transformImpacts,
							kq: transformedIngredientsMass,
							aO: ingredientsTransport
						},
						eZ: scoring,
						a3: totalImpacts,
						fk: $author$project$Data$Food$Recipe$getMassAtPackaging(recipe),
						aO: $author$project$Data$Transport$sum(
							_List_fromArray(
...
var $author$project$Data$Textile$Formula$bleachingImpacts = F3(
	function (impacts, _v0, baseMass) {
		var aquaticPollutionScenario = _v0.ft;
		var bleachingProcess = _v0.hU;
		return A2(
			$author$project$Data$Impact$mapImpacts,
			F2(
				function (trigram, _v1) {
					return A2(
						...
						A2(
							...
							A2($author$project$Data$Process$getImpact, trigram, bleachingProcess),
							baseMass));
				}),
			impacts);
	});
...
var $author$project$Data$Textile$Simulator$computeBleachingImpacts = F2(
	function (_v0, simulator) {
		...
		return A3(
			...
			function (step) {
				var impacts = A3(
					$author$project$Data$Textile$Formula$bleachingImpacts,
					step.z,
					{ft: step.fK.ft, hU: textile.kC.hT},
					step.jE);
				return _Utils_update(
					step,
					{
...
var $author$project$Data$Textile$Economics$computeTraceabilityIndex = function (traceability) {
	return $author$project$Data$Unit$ratio(
		traceability ? 1 : 0);
};
		...
		A2(
			...
			_List_fromArray(
				[
					_Utils_Tuple2(
					0.4,
					$author$project$Data$Textile$Economics$computeNumberOfReferencesIndex(economics.gA)),
					_Utils_Tuple2(
					0.4,
					A3($author$project$Data$Textile$Economics$computeRepairCostIndex, economics.fB, economics.gL, economics.gW)),
					_Utils_Tuple2(
					0.2,
					$author$project$Data$Textile$Economics$computeTraceabilityIndex(economics.hm))
				])));
	var _v0 = _Utils_Tuple2(
...
var $author$project$Data$Textile$Simulator$computeDurability = function (simulator) {
	...
	var nonPhysicalDurability = $author$project$Data$Textile$Economics$computeNonPhysicalDurabilityIndex(
		{
			fB: A2($elm$core$Maybe$withDefault, inputs.a2.is.fB, inputs.fB),
			gA: A2($elm$core$Maybe$withDefault, inputs.a2.is.gA, inputs.gA),
			gL: A2($elm$core$Maybe$withDefault, inputs.a2.is.gL, inputs.gL),
			gW: inputs.a2.is.gW,
			hm: A2($elm$core$Maybe$withDefault, inputs.a2.is.hm, inputs.hm)
		});
	var newDurability = {gy: nonPhysicalDurability, eT: simulator.aj.eT};
	return _Utils_update(
		simulator,
		{
			ek: A2(
				...
				simulator.ek),
			aj: newDurability,
			ky: $elm$core$Basics$round(
				simulator.ky * $author$project$Data$Unit$floatDurabilityFromHolistic(newDurability))
		});
};
...
var $author$project$Data$Textile$Step$emptyPreTreatments = {ez: $ianmackenzie$elm_units$Quantity$zero, z: $author$project$Data$Impact$empty, ax: $ianmackenzie$elm_units$Quantity$zero, bz: _List_Nil};
var $author$project$Data$Textile$WellKnown$getEnnoblingPreTreatments = F2(
	function (origin, _v0) {
		var bleaching = _v0.hT;
		var degreasing = _v0.fR;
			...
			A2(
				...
				function (_v1) {
					...
					return A2(
						...
						A2($author$project$Data$Textile$WellKnown$getEnnoblingPreTreatments, material.gC, wellKnown));
				},
				materials));
	});
...
var $author$project$Data$Textile$Material$Origin$Synthetic = 4;
...
var $author$project$Data$Textile$Formula$materialDyeingToxicityImpacts = F4(
	function (impacts, _v0, baseMass, split) {
		var aquaticPollutionScenario = _v0.ft;
		var dyeingToxicityProcess = _v0.ir;
		return A2(
			$author$project$Data$Impact$mapImpacts,
			F2(
				function (trigram, _v1) {
...
var $author$project$Data$Textile$Dyeing$toProcess = F2(
	function (_v0, processType) {
		var dyeingProcessAverage = _v0.$9;
		var dyeingProcessContinuous = _v0.io;
		var dyeingProcessDiscontinuous = _v0.ip;
		_v1$2:
		while (true) {
			if (!processType.$) {
	...
	function (_v0, simulator) {
		...
		return A3(
			...
			function (step) {
				...
				var preTreatments = A3($author$project$Data$Textile$Step$computePreTreatments, textile.kC, inputs.jc, step);
				var heatProcess = A2($author$project$Data$Textile$WellKnown$getEnnoblingHeatProcess, textile.kC, country);
					...
					A2(
						...
						function (_v2) {
							...
							return A4(
								...
								{
									ft: step.fK.ft,
									ir: $author$project$Data$Textile$Material$Origin$isSynthetic(material.gC) ? textile.kC.iq : textile.kC.im
								},
								step.jE,
								share);
						},
						inputs.jc));
				var dyeingProcess = A2($author$project$Data$Textile$Dyeing$toProcess, textile.kC, dyeingProcessType);
				var _v1 = A5($author$project$Data$Textile$Formula$dyeingImpacts, step.z, dyeingProcess, heatProcess, country.fW, step.jE);
				var heat = _v1.ez;
				var impacts = _v1.z;
				var kwh = _v1.ax;
				return _Utils_update(
					step,
					{
						...
						z: $author$project$Data$Impact$sumImpacts(
							_List_fromArray(
								[step.z, impacts, dyeingToxicity, preTreatments.z])),
...
var $author$project$Data$Textile$Formula$endOfLifeImpacts = F3(
	function (impacts, _v0, baseMass) {
		...
		var endOfLife = _v0.iy;
		var heatProcess = _v0.f5;
		...
		return A3(
			...
			function (step) {
				...
				var _v1 = A3(
					...
					step.z,
					{b3: country.fW, iy: textile.kC.iy, f5: country.f5, jF: textile.kC.jF, kA: simulator.u.a2.iy.kA},
					step.jE);
				var heat = _v1.ez;
				var impacts = _v1.z;
				var kwh = _v1.ax;
	...
	function (impacts, _v0) {
		...
		return {
			z: A2(
				...
				impacts),
			ax: electricityKWh,
			gG: $elm$core$Maybe$Just(picking),
			hj: $elm$core$Maybe$Just(threadDensity)
		};
	});
		...
		return A3(
			...
			function (step) {
				...
				var process = A2(
					...
					textile.kC,
					A2($elm$core$Maybe$withDefault, inputs.a2.fZ, inputs.bj));
				var _v1 = function () {
					if ($author$project$Data$Textile$Fabric$isKnitted(
						...
						return A3(
							...
							step.z,
							{b3: country.fW, eo: process.eo},
							step.jE);
					} else {
						var surfaceMass = A2($elm$core$Maybe$withDefault, inputs.a2.e5, inputs.e5);
						return A2(
							...
							step.z,
							{
								...
								e5: surfaceMass,
								kE: A2($elm$core$Maybe$withDefault, inputs.a2.kE, inputs.kE)
							});
					}
				}();
				var impacts = _v1.z;
				var kwh = _v1.ax;
				var picking = _v1.gG;
				var threadDensity = _v1.hj;
				return _Utils_update(
					step,
					{z: impacts, ax: kwh, gG: picking, hj: threadDensity});
			},
			simulator);
	});
	...
	function (_v0, simulator) {
		...
		var _v1 = A2(
			...
			A2(
				$author$project$Data$Textile$Fabric$getProcess,
				textile.kC,
				A2($elm$core$Maybe$withDefault, inputs.a2.fZ, inputs.bj)).hz,
			A4(
				$author$project$Data$Textile$LifeCycle$getStepProp,
				4,
				function ($) {
...
var $author$project$Data$Textile$Formula$finishingImpacts = F3(
	function (impacts, _v0, baseMass) {
		var elecProcess = _v0.fV;
		var finishingProcess = _v0.iH;
		var heatProcess = _v0.f5;
		var _v1 = _Utils_Tuple2(
			A2(
				$ianmackenzie$elm_units$Quantity$multiplyBy,
			...
			function (step) {
				...
				var _v1 = A3(
					...
					step.z,
					{
						fV: country.fW,
						iH: textile.kC.iG,
						f5: A2($author$project$Data$Textile$WellKnown$getEnnoblingHeatProcess, textile.kC, country)
					},
					step.jE);
				var heat = _v1.ez;
				var impacts = _v1.z;
...
var $author$project$Data$Textile$Formula$makingImpacts = F3(
	function (impacts, _v0, outputMass) {
		var countryElecProcess = _v0.b3;
		var countryHeatProcess = _v0.h6;
		var fadingProcess = _v0.iF;
			...
			function (step) {
				...
				var _v1 = A3(
					...
					step.z,
					{
						...
						iF: _Utils_eq(
							inputs.cb,
							$elm$core$Maybe$Just(true)) ? $elm$core$Maybe$Just(textile.kC.cb) : $elm$core$Maybe$Nothing,
						i9: A3($author$project$Data$Textile$Fabric$getMakingComplexity, inputs.a2.eI.ef, inputs.i9, inputs.bj)
					},
					step.jE);
				var heat = _v1.ez;
				var impacts = _v1.z;
...
var $author$project$Data$Textile$Formula$makingDeadStock = F2(
	function (deadstock, baseMass) {
		var mass = A2(
			...
			baseMass);
		return {
			h9: A2($ianmackenzie$elm_units$Quantity$minus, baseMass, mass),
			T: mass
		};
	});
...
var $author$project$Data$Textile$Simulator$computeMakingStepWaste = function (simulator) {
	...
	var _v1 = A2(
		$author$project$Data$Textile$Formula$genericWaste,
		A3($author$project$Data$Textile$Fabric$getMakingWaste, product.eI.gF, makingWaste, fabricProcess),
		inputs.T);
	var mass = _v1.T;
	var waste = _v1.hz;
	return A3(
	...
	function (_v0, material, step) {
		...
		if (!_v1.$) {
			...
			return A3(
				...
				step.z,
				{h$: cffData, ju: sourceMaterial.gp, jV: material.gp},
				step.jE);
		} else {
			return A3($author$project$Data$Textile$Formula$pureMaterialImpacts, step.z, material.gp, step.jE);
		}
	});
...
var $author$project$Data$Textile$WellKnown$getPrintingProcess = F2(
	function (medium, _v0) {
		var printingDyes = _v0.gM;
		var printingPaste = _v0.gN;
		var printingPigment = _v0.gO;
		var printingSubstantive = _v0.gP;
		if (!medium) {
		...
		return A3(
			...
			function (step) {
				...
				if (!_v1.$) {
					var kind = _v1.a.eF;
					var ratio = _v1.a.jR;
					var _v2 = A2($author$project$Data$Textile$WellKnown$getPrintingProcess, kind, textile.kC);
					...
					var printingToxicity = A4(
						...
						step.z,
						{
							...
							e5: A2($elm$core$Maybe$withDefault, inputs.a2.e5, inputs.e5)
						},
						ratio,
						step.jE);
					var _v3 = A3(
...
var $author$project$Data$Textile$Material$Spinning$normalization = function (spinning) {
	switch (spinning) {
		case 0:
			return $author$project$Data$Textile$Material$Spinning$processesData.eg.gz;
		case 1:
			return $author$project$Data$Textile$Material$Spinning$processesData.e6.gz;
		default:
			return $author$project$Data$Textile$Material$Spinning$processesData.fl.gz;
	}
};
...
var $author$project$Data$Textile$Simulator$stepSpinningImpacts = F4(
	function (material, maybeSpinning, product, step) {
		var yarnSize = A2($elm$core$Maybe$withDefault, product.kE, step.kE);
		var spinning = A2(
			$elm$core$Maybe$withDefault,
			$author$project$Data$Textile$Material$Spinning$getDefault(material.gC),
			maybeSpinning);
						...
						A2(
							...
							function (_v0) {
								...
								return A2(
									...
									A4($author$project$Data$Textile$Simulator$stepSpinningImpacts, material, spinning, inputs.a2, step).z);
							},
							inputs.jc)),
					ax: A3(
						$elm$core$List$foldl,
						...
						A2(
							...
							function (_v2) {
								...
								return A2(
									$ianmackenzie$elm_units$Quantity$multiplyBy,
									$author$project$Data$Split$toFloat(share),
									A4($author$project$Data$Textile$Simulator$stepSpinningImpacts, material, spinning, inputs.a2, step).ax);
							},
							inputs.jc))
				});
		},
	...
	function (a, b) {
		return _Utils_update(
			b,
			{
				...
				g3: A2($ianmackenzie$elm_units$Quantity$plus, a.g3, b.g3)
			});
	});
var $author$project$Data$Textile$Step$computeTransportSummary = F2(
	function (step, transport) {
		var noTransports = $author$project$Data$Transport$default(step.c6.z);
		var _v0 = step._;
		switch (_v0) {
			case 0:
				return A2(
...
var $author$project$Data$Textile$Step$computeTransports = F4(
	function (db, inputs, next, current) {
		...
		var transport = (current._ === 5) ? $author$project$Data$Transport$sum(
			A2(
				$elm$core$List$map,
				A3($author$project$Data$Textile$Step$computeMaterialTransportAndImpact, db, next.fK, current.jE),
				inputs.jc)) : A5(
			$author$project$Data$Textile$Step$computeTransportImpacts,
			current.c6.z,
			db.kk.kC,
			...
			A2(
				...
				current,
				A4($author$project$Data$Transport$getTransportBetween, current.c6.z, current.fK.cK, next.fK.cK, db.ii)));
		return _Utils_update(
			current,
			{
				ab: _Utils_update(
					processInfo,
					{
						bX: $elm$core$Maybe$Just(
							$author$project$Data$Process$getDisplayName(db.kk.kC.bX)),
						bI: $elm$core$Maybe$Just(
							$author$project$Data$Process$getDisplayName(db.kk.kC.bI)),
						cr: $elm$core$Maybe$Just(
							$author$project$Data$Process$getDisplayName(db.kk.kC.cr))
					}),
				c6: transport
			});
	});
		...
		function (_v0, acc) {
			...
			return _Utils_update(
				acc,
				{
					...
					g3: A2($ianmackenzie$elm_units$Quantity$plus, transport.g3, acc.g3)
				});
		}),
	$author$project$Data$Transport$default($author$project$Data$Impact$empty));
var $author$project$Data$Textile$Simulator$computeTotalTransportImpacts = function (simulator) {
	return _Utils_update(
		simulator,
		{
			c6: $author$project$Data$Textile$LifeCycle$computeTotalTransportImpacts(simulator.J)
		});
};
...
var $author$project$Data$Component$computeMaterialResults = F2(
	function (amount, process) {
		var mass = $ianmackenzie$elm_units$Mass$kilograms(
			(process.hs === 'kg') ? $author$project$Data$Component$amountToFloat(amount) : ($author$project$Data$Component$amountToFloat(amount) * process.$8));
		var impacts = A2(
			$author$project$Data$Impact$multiplyBy,
...
var $author$project$Data$Component$emptyResults = {z: $author$project$Data$Impact$empty, S: _List_Nil, T: $ianmackenzie$elm_units$Quantity$zero, aM: $elm$core$Maybe$Nothing};
	...
	function (db, simulator) {
		...
		return A2(
			...
			A2(
				...
				A2($author$project$Data$Component$compute, db, simulator.u.ku)));
	});
var $author$project$Data$Textile$Formula$useImpacts = F3(
	function (impacts, _v0, baseMass) {
		var countryElecProcess = _v0.b3;
		var ironingElec = _v0.iX;
		var nonIroningProcess = _v0.jt;
		var useNbCycles = _v0.ky;
		var totalEnergy = A2(
			$ianmackenzie$elm_units$Quantity$multiplyBy,
			useNbCycles,
			$ianmackenzie$elm_units$Quantity$sum(
	...
	return A3(
		...
		function (step) {
			...
			var _v0 = A3(
				...
				step.z,
				{b3: country.fW, iX: inputs.a2.hu.iX, jt: inputs.a2.hu.jt, ky: useNbCycles},
				step.jE);
			var impacts = _v0.z;
			var kwh = _v0.ax;
			return _Utils_update(
	...
	function (db, simulator) {
		...
		var trimsMass = A2(
			...
			A2(
				...
				A2($author$project$Data$Component$compute, db, inputs.ku)));
		return A3(
			$author$project$Data$Textile$Simulator$updateLifeCycleSteps,
			_List_fromArray(
				[5, 6, 3, 2]),
																								...
																								return function (surfaceMass) {
																									return function (traceability) {
																										return function (trims) {
																											return function (upcycled) {
																												return function (yarnSize) {
																													return {bY: airTransportRatio, fB: business, eh: countryDistribution, aV: countryDyeing, ei: countryEndOfLife, bb: countryFabric, bc: countryMaking, fL: countryMaterial, b4: countrySpinning, ej: countryUse, b6: disabledSteps, b7: dyeingProcessType, bj: fabricProcess, cb: fading, i9: makingComplexity, cl: makingDeadStock, cm: makingWaste, T: mass, jc: materials, gA: numberOfReferences, co: physicalDurability, gL: price, cp: printing, a2: product, e5: surfaceMass, hm: traceability, ku: trims, cz: upcycled, kE: yarnSize};
																												};
																											};
																										};
																									};
					...
					return A3(
						...
						F2(
							function (material_, country_) {
								return {fK: country_, aa: material_, ac: share, cu: spinning};
							}),
						A2($author$project$Data$Textile$Material$findById, id, materials),
						countryResult);
				}),
...
var $author$project$Data$Textile$Inputs$fromQuery = F2(
	function (_v0, query) {
		...
		return A2(
			$elm_community$result_extra$Result$Extra$andMap,
			$elm$core$Result$Ok(query.kE),
			A2(
				$elm_community$result_extra$Result$Extra$andMap,
				$elm$core$Result$Ok(query.cz),
				A2(
					$elm_community$result_extra$Result$Extra$andMap,
					$elm$core$Result$Ok(query.ku),
					A2(
						$elm_community$result_extra$Result$Extra$andMap,
						$elm$core$Result$Ok(query.hm),
						A2(
							...
							A2(
								$elm_community$result_extra$Result$Extra$andMap,
								A2($author$project$Data$Textile$Product$findById, query.a2, textile.jP),
								A2(
									$elm_community$result_extra$Result$Extra$andMap,
									$elm$core$Result$Ok(query.cp),
									A2(
										$elm_community$result_extra$Result$Extra$andMap,
										$elm$core$Result$Ok(query.gL),
										A2(
											$elm_community$result_extra$Result$Extra$andMap,
											$elm$core$Result$Ok(query.co),
											A2(
												$elm_community$result_extra$Result$Extra$andMap,
												$elm$core$Result$Ok(query.gA),
												A2(
													$elm_community$result_extra$Result$Extra$andMap,
													materials_,
													A2(
																								...
																								A2(
																									...
																									A2(
																										...
																										A2(
																											...
																											A2(
																												$elm_community$result_extra$Result$Extra$andMap,
																												A2(getCountryResult, unknownCountryResult, query.aV),
																												A2(
																													$elm_community$result_extra$Result$Extra$andMap,
																													franceResult,
																													A2(
																														$elm_community$result_extra$Result$Extra$andMap,
																														$elm$core$Result$Ok(query.fB),
																														A2(
																															$elm_community$result_extra$Result$Extra$andMap,
...
var $author$project$Data$Textile$Inputs$countryList = function (inputs) {
	return _List_fromArray(
		[inputs.fL, inputs.b4, inputs.bb, inputs.aV, inputs.bc, inputs.eh, inputs.ej, inputs.ei]);
};
var $author$project$Data$Textile$Step$defaultProcessInfo = {bX: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, cM: $elm$core$Maybe$Nothing, cO: $elm$core$Maybe$Nothing, en: $elm$core$Maybe$Nothing, iy: $elm$core$Maybe$Nothing, fZ: $elm$core$Maybe$Nothing, cb: $elm$core$Maybe$Nothing, eI: $elm$core$Maybe$Nothing, jF: $elm$core$Maybe$Nothing, cp: $elm$core$Maybe$Nothing, bI: $elm$core$Maybe$Nothing, cr: $elm$core$Maybe$Nothing, d2: $elm$core$Maybe$Nothing, d3: $elm$core$Maybe$Nothing};
...
var $author$project$Data$Textile$Step$create = function (_v0) {
	...
	return {
		...
		h3: $author$project$Data$Impact$noComplementsImpacts,
		fK: country,
		h9: $ianmackenzie$elm_units$Quantity$zero,
		...
		hj: $elm$core$Maybe$Nothing,
		c6: $author$project$Data$Transport$default(defaultImpacts),
...
var $cuducos$elm_format_number$FormatNumber$Parser$FormattedNumber = F5(
	function (original, integers, decimals, prefix, suffix) {
		return {ia: decimals, gg: integers, gD: original, dI: prefix, dU: suffix};
	});
	...
	var onlyZeros = A2(
		...
		$elm$core$String$concat(
			A2(
				...
				formatted.gg,
				$elm$core$List$singleton(formatted.ia))));
	return onlyZeros ? 1 : ((formatted.gD < 0) ? 2 : 0);
};
...
var $cuducos$elm_format_number$FormatNumber$Stringfy$stringfy = F2(
	function (locale, formatted) {
		...
		var integers = A2($elm$core$String$join, locale.bN, formatted.gg);
		var decimals = stringfyDecimals(formatted.ia);
...
var $cuducos$elm_format_number$FormatNumber$Locales$base = {
	bd: '.',
	ia: $cuducos$elm_format_number$FormatNumber$Locales$Min(0),
	dC: '−',
	eK: '',
	gJ: '',
	gK: '',
...
var $cuducos$elm_format_number$FormatNumber$Locales$frenchLocale = _Utils_update(
	...
	{
		bd: ',',
		ia: $cuducos$elm_format_number$FormatNumber$Locales$Exact(3),
		bN: '\u202F'
	});
			...
			return A2(
				...
				$cuducos$elm_format_number$FormatNumber$format(
					_Utils_update(
						...
						{
							ia: $cuducos$elm_format_number$FormatNumber$Locales$Exact(dc)
						})),
				A2($elm$core$String$replace, '−', '-'));
		};
	...
	return A2(
		...
		$elm$core$List$filterMap(
			function (_v0) {
				var material = _v0.aa;
				var share = _v0.ac;
				return _Utils_eq(material.gC, origin) ? $elm$core$Maybe$Just(
...
var $author$project$Data$Textile$Inputs$getOutOfEuropeEOLProbability = function (materialInputs) {
	var syntheticMaterialsShare = A2($author$project$Data$Textile$Inputs$getMaterialCategoryShare, 4, materialInputs);
	return A2(
		$elm$core$Result$withDefault,
		$author$project$Data$Split$zero,
...
var $author$project$Data$Textile$Inputs$getMaterialMicrofibersComplement = F2(
	function (finalProductMass, _v0) {
		...
		return A2(
			$ianmackenzie$elm_units$Quantity$multiplyBy,
			materialMassInKg,
			$author$project$Data$Textile$Material$Origin$toMicrofibersComplement(material.gC));
	});
...
var $author$project$Data$Textile$Step$updateFromInputs = F3(
	function (_v0, inputs, step) {
		...
		var label = step._;
		var country = step.fK;
		var complementsImpacts = step.h3;
		var _v1 = inputs;
						...
						ab: _Utils_update(
							$author$project$Data$Textile$Step$defaultProcessInfo,
							{
								aE: $elm$core$Maybe$Just(
									$author$project$Data$Process$getDisplayName(country.fW)),
								cM: $elm$core$Maybe$Just(
									$author$project$Data$Process$getDisplayName(country.f5)),
								iy: $elm$core$Maybe$Just(
									$author$project$Data$Process$getDisplayName(wellKnown.iy)),
							...
							$author$project$Data$Textile$Step$defaultProcessInfo,
							{
								...
								fZ: $elm$core$Maybe$Just(
									$author$project$Data$Process$getDisplayName(
										A2($author$project$Data$Textile$Fabric$getProcess, wellKnown, inputs.a2.fZ)))
							}),
						e5: surfaceMass,
						kE: yarnSize
					});
								...
								d2: $elm$core$Maybe$Just(
									function (x) {
										...
										A2(
											...
											4,
											$ianmackenzie$elm_units$Energy$inKilowattHours(inputs.a2.hu.iX)))),
								d3: $elm$core$Maybe$Just(
									$author$project$Data$Process$getDisplayName(inputs.a2.hu.jt))
							})
					});
		}
	});
...
var $author$project$Data$Textile$Simulator$init = function (db) {
	return A2(
		...
		A2(
			...
			$elm$core$Result$map(
				function (inputs) {
					var product = inputs.a2;
					return function (lifeCycle) {
						return {
							h3: $author$project$Data$Impact$noComplementsImpacts,
							ek: inputs.a2.hu.ek,
							aj: {
								gy: $author$project$Data$Unit$standardDurability($elm$core$Basics$identity),
								eT: A2(
									$elm$core$Maybe$withDefault,
									$author$project$Data$Unit$maxDurability($elm$core$Basics$identity),
									inputs.co)
							...
							u: inputs,
							J: lifeCycle,
							c6: $author$project$Data$Transport$default($author$project$Data$Impact$empty),
							c8: $author$project$Data$Impact$empty,
							ky: $author$project$Data$Textile$Product$customDaysOfWear(product.hu)
						};
					}(
							...
							A3(
								...
								A3(
									...
									A3(
										nextWithDbIf,
										2,
										$author$project$Data$Textile$Simulator$computeBleachingImpacts,
										A3(
											nextWithDbIf,
											2,
	...
	return $author$project$Data$Common$EncodeUtils$optionalPropertiesObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'country',
				A2($elm$core$Maybe$map, $author$project$Data$Country$encodeCode, v.fK)),
				_Utils_Tuple2(
				'id',
				$elm$core$Maybe$Just(
					$author$project$Data$Textile$Material$encodeId(v.H))),
	...
	return $author$project$Data$Common$EncodeUtils$optionalPropertiesObject(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'business',
				A2($elm$core$Maybe$map, $author$project$Data$Textile$Economics$encodeBusiness, query.fB)),
				_Utils_Tuple2(
				'countryDyeing',
				A2($elm$core$Maybe$map, $author$project$Data$Country$encodeCode, query.aV)),
				_Utils_Tuple2(
				'countryFabric',
				...
				_Utils_Tuple2(
				'numberOfReferences',
				A2($elm$core$Maybe$map, $elm$json$Json$Encode$int, query.gA)),
				_Utils_Tuple2(
				'physicalDurability',
				A2($elm$core$Maybe$map, $author$project$Data$Unit$encodePhysicalDurability, query.co)),
				_Utils_Tuple2(
				'price',
				A2($elm$core$Maybe$map, $author$project$Data$Textile$Economics$encodePrice, query.gL)),
				_Utils_Tuple2(
				'printing',
				...
				$elm$core$Maybe$Just(
					$elm$json$Json$Encode$string(
						$author$project$Data$Textile$Product$idToString(query.a2)))),
				_Utils_Tuple2(
				'surfaceMass',
				A2($elm$core$Maybe$map, $author$project$Data$Unit$encodeSurfaceMass, query.e5)),
				_Utils_Tuple2(
				'traceability',
				A2($elm$core$Maybe$map, $elm$json$Json$Encode$bool, query.hm)),
				_Utils_Tuple2(
				'trims',
				$elm$core$Maybe$Just(
					A2($elm$json$Json$Encode$list, $author$project$Data$Component$encodeItem, query.ku))),
				_Utils_Tuple2(
				'upcycled',
				$elm$core$Maybe$Just(
				...
				_Utils_Tuple2(
				'yarnSize',
				A2($elm$core$Maybe$map, $author$project$Data$Unit$encodeYarnSize, query.kE))
			]));
};
...
var $author$project$Data$Textile$Inputs$toQuery = function (inputs) {
	return {
		bY: inputs.bY,
		fB: inputs.fB,
		aV: $author$project$Data$Textile$Inputs$toQueryCountryCode(inputs.aV.cK),
	...
	return A2(
		...
		$cuducos$elm_format_number$FormatNumber$format(
			_Utils_update(
				$cuducos$elm_format_number$FormatNumber$Locales$frenchLocale,
				{
					ia: $cuducos$elm_format_number$FormatNumber$Locales$Exact(decimals)
				})));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							if (!_v2.$) {
								var printing = _v2.a;
								return 'impression ' + ($author$project$Data$Textile$Printing$toFullLabel(printing) + ('\u00A0: ' + inputs.aV.L));
							} else {
								return 'non';
							}
						}()
	...
	return $author$project$Data$Common$EncodeUtils$optionalPropertiesObject(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'byPlane',
				$author$project$Data$Food$Ingredient$encodePlaneTransport(v.gI))
			]));
};
	...
	return $author$project$Data$Common$EncodeUtils$optionalPropertiesObject(
		_List_fromArray(
			[
				...
				'ingredients',
				$elm$core$Maybe$Just(
					A2($elm$json$Json$Encode$list, $author$project$Data$Food$Query$encodeIngredient, v.iS))),
				_Utils_Tuple2(
				'transform',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'components',
				A2($elm$json$Json$Encode$list, $author$project$Data$Component$encodeItem, query.dj))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'climate',
				$author$project$Data$Unit$encodeImpact(scoring.h1)),
				_Utils_Tuple2(
				'biodiversity',
				$author$project$Data$Unit$encodeImpact(scoring.hS)),
				_Utils_Tuple2(
				'health',
				$author$project$Data$Unit$encodeImpact(scoring.iL)),
				_Utils_Tuple2(
				'resources',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'total',
							$author$project$Data$Impact$encode(results.aL.a3)),
							_Utils_Tuple2(
							'ingredientsTotal',
							$author$project$Data$Impact$encode(results.aL.eD)),
							_Utils_Tuple2(
							'totalBonusImpact',
							$author$project$Data$Impact$encodeComplementsImpacts(results.aL.hl)),
							_Utils_Tuple2(
							'transform',
							$author$project$Data$Impact$encode(results.aL.bQ)),
							_Utils_Tuple2(
							'transports',
							$author$project$Data$Transport$encode(results.aL.aO))
						]))),
				_Utils_Tuple2(
				'packaging',
				...
				_Utils_Tuple2(
				'preparation',
				$author$project$Data$Impact$encode(results.aK)),
				_Utils_Tuple2(
				'transports',
				$author$project$Data$Transport$encode(results.aO)),
				_Utils_Tuple2(
				'distribution',
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'transports',
							$author$project$Data$Transport$encode(results.cO.aO))
						])))
			]));
};
			...
			switch (_v0.a.$) {
				...
				case 1:
					...
					return A2(
						$author$project$Server$respondWith,
						200,
						$author$project$Server$encodeIngredients(db.cS.iS));
				case 2:
					var _v3 = _v0.a;
					return A2(
						$author$project$Server$respondWith,
				...
				case 9:
					if (!_v0.a.a.$) {
						...
						return A3(
							...
							db,
							$author$project$Server$toAllImpactsSimple(db.kk.kC),
							textileQuery);
					} else {
						var error = _v0.a.a.a;
						return A2(
				...
				default:
					if (!_v0.a.a.$) {
						...
						return A3(
							$author$project$Server$executeTextileQuery,
							db,
							A2($author$project$Server$toSingleImpactSimple, db.kk.kC, trigram),
							textileQuery);
					} else {
						var _v10 = _v0.a;
						var error = _v10.a.a;
...
var $author$project$Static$Db$Db = F8(
	function (components, countries, definitions, distances, food, object, processes, textile) {
		return {dj: components, h5: countries, ie: definitions, ii: distances, cS: food, jw: object, dJ: processes, kk: textile};
	});
var $author$project$Data$Food$Db$Db = F3(
	function (examples, ingredients, wellKnown) {
		return {iA: examples, iS: ingredients, kC: wellKnown};
	});
											...
											return function (scenario) {
												return function (transportCooling) {
													return function (visible) {
														return {eb: categories, h7: cropGroup, fQ: defaultOrigin, $8: density, it: ecosystemicServices, H: id, iR: inediblePart, i2: landOccupation, L: name, jO: process, jT: rawToCookedRatio, j4: scenario, kr: transportCooling, hx: visible};
													};
												};
											};
										};
...
var $author$project$Data$Food$EcosystemicServices$AbstractEcosystemicServices = F5(
	function (cropDiversity, hedges, livestockDensity, permanentPasture, plotSize) {
		return {dk: cropDiversity, du: hedges, dz: livestockDensity, dG: permanentPasture, dH: plotSize};
	});
...
var $author$project$Data$Food$Ingredient$decodeTransportCooling = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Data$Food$EcosystemicServices$empty = {dk: $author$project$Data$Unit$noImpacts, du: $author$project$Data$Unit$noImpacts, dz: $author$project$Data$Unit$noImpacts, dG: $author$project$Data$Unit$noImpacts, dH: $author$project$Data$Unit$noImpacts};
...
var $author$project$Data$Example$Example = F5(
	function (category, id, name, query, scope) {
		return {fD: category, H: id, L: name, dK: query, g2: scope};
	});
...
var $author$project$Data$Food$WellKnown$WellKnown = F8(
	function (boatCoolingTransport, boatTransport, domesticGasHeat, lorryCoolingTransport, lorryTransport, lowVoltageElectricity, planeTransport, water) {
		return {hV: boatCoolingTransport, hW: boatTransport, ik: domesticGasHeat, i6: lorryCoolingTransport, i7: lorryTransport, i8: lowVoltageElectricity, gI: planeTransport, bV: water};
	});
...
var $author$project$Data$Textile$Db$Db = F4(
	function (examples, materials, products, wellKnown) {
		return {iA: examples, jc: materials, jP: products, kC: wellKnown};
	});
							...
							return function (recycledFrom) {
								return function (recycledProcess) {
									return function (shortName) {
										return {h$: cffData, fN: defaultCountry, iJ: geographicOrigin, H: id, gp: materialProcess, L: name, gC: origin, eW: recycledFrom, jV: recycledProcess, ka: shortName};
									};
								};
							};
						};
...
var $author$project$Data$Textile$Material$Origin$ArtificialFromInorganic = 0;
var $author$project$Data$Textile$Material$Origin$ArtificialFromOrganic = 1;
var $author$project$Data$Textile$Material$Origin$NaturalFromAnimal = 2;
var $author$project$Data$Textile$Material$Origin$NaturalFromVegetal = 3;
var $author$project$Data$Textile$Material$Origin$fromString = function (origin) {
	switch (origin) {
		case 'ArtificialFromInorganic':
			return $elm$core$Result$Ok(0);
					...
					return function (name) {
						return function (surfaceMass) {
							return function (trims) {
								return function (use) {
									return function (yarnSize) {
										return {is: economics, iy: endOfLife, fZ: fabric, H: id, eI: making, L: name, e5: surfaceMass, ku: trims, hu: use, kE: yarnSize};
									};
								};
							};
						};
...
var $author$project$Data$Textile$Economics$Economics = F5(
	function (business, numberOfReferences, price, repairCost, traceability) {
		return {fB: business, gA: numberOfReferences, gL: price, gW: repairCost, hm: traceability};
	});
...
var $author$project$Data$Textile$Product$MakingOptions = F2(
	function (complexity, pcrWaste) {
		return {ef: complexity, gF: pcrWaste};
	});
...
var $author$project$Data$Textile$Product$UseOptions = F8(
	function (daysOfWear, defaultNbCycles, ironingElec, nonIroningProcess, ratioDryer, ratioIroning, timeIroning, wearsPerCycle) {
		return {ek: daysOfWear, fP: defaultNbCycles, iX: ironingElec, jt: nonIroningProcess, gR: ratioDryer, gS: ratioIroning, hk: timeIroning, fn: wearsPerCycle};
	});
																											...
																											return function (trainTransport) {
																												return function (washingSyntheticFibers) {
																													return function (weaving) {
																														return {bX: airTransport, hT: bleaching, fR: degreasing, cO: distribution, im: dyeingCellulosic, $9: dyeingProcessAverage, io: dyeingProcessContinuous, ip: dyeingProcessDiscontinuous, iq: dyeingSynthetic, iw: elecMediumTensionAsia, iy: endOfLife, cb: fading, iG: finishing, f4: heatEurope, f6: heatRoW, iZ: knittingCircular, i_: knittingFullyFashioned, i$: knittingMix, i0: knittingSeamless, i1: knittingStraight, jF: passengerCar, gM: printingDyes, gN: printingPaste, gO: printingPigment, gP: printingSubstantive, bI: roadTransport, cr: seaTransport, kp: trainTransport, hy: washingSyntheticFibers, kB: weaving};
																													};
																												};
																											};
																										};
...
var $author$project$Data$Country$Country = F7(
	function (aquaticPollutionScenario, code, electricityProcess, heatProcess, name, scopes, zone) {
		return {ft: aquaticPollutionScenario, cK: code, fW: electricityProcess, f5: heatProcess, L: name, M: scopes, hI: zone};
	});
										...
										return function (sourceId) {
											return function (unit) {
												return function (waste) {
													return {eb: categories, fI: comment, $8: density, em: displayName, eo: elec, ez: heat, H: id, z: impacts, M: scopes, hb: source, e0: sourceId, hs: unit, hz: waste};
												};
											};
										};
									};
...
var $author$project$Data$Transport$Transport = F6(
	function (air, impacts, road, roadCooled, sea, seaCooled) {
		return {hK: air, z: impacts, dP: road, j2: roadCooled, g3: sea, j7: seaCooled};
	});
...
var $author$project$Data$Impact$Definition$Definition = F7(
	function (trigram, label, description, unit, decimals, pefData, ecoscoreData) {
		return {ia: decimals, ig: description, fU: ecoscoreData, _: label, jG: pefData, kt: trigram, hs: unit};
	});
var $author$project$Data$Impact$Definition$AggregatedScoreData = F3(
	function (color, normalization, weighting) {
		return {aU: color, gz: normalization, hA: weighting};
	});
...
var $author$project$Static$Json$rawJsonComponents = {jx: $author$project$Static$Json$objectComponentsJson, kl: $author$project$Static$Json$textileComponentsJson, kz: $author$project$Static$Json$veliComponentsJson};
...
var $author$project$Static$Json$textileProductExamplesJson = '[{"category":"Tshirt / Polo","id":"c0500a78-8b40-4e92-88df-c2a39e1a08c3","name":"Tshirt lin (150g) - France - Mode \\"éthique\\"","query":{"business":"small-business","countryDyeing":"FR","countryFabric":"FR","countryMaking":"FR","countrySpinning":"TR","mass":0.15,"materials":[{"id":"ei-lin","share":1}],"numberOfReferences":200,"price":30,"product":"tshirt","traceability":true},"scope":"textile"},{"category":"Tshirt / Polo","id":"b9dc9be5-ba32-4b8c-9190-b93098cf1d0d","name":"Tshirt coton bio (150g) - France - Mode \\"éthique\\"","query":{"business":"small-business","countryDyeing":"FR","countryFabric":"FR","countryMaking":"FR","countrySpinning":"TR","mass":0.15,"materials":[{"id":"ei-coton-organic","share":1}],"numberOfReferences":200,"price":30,"product":"tshirt","traceability":true},"scope":"textile"},{"category":"Pull","id":"dffc6a19-794a-4d14-ad1a-bc3512359f22","name":"Pull polyester (550g) - Asie - Mode \\"ultra fast fashion\\"","query":{"business":"large-business-without-services","countryDyeing":"RAS","countryFabric":"RAS","countryMaking":"RAS","countrySpinning":"RAS","mass":0.55,"materials":[{"id":"ei-pet","share":1}],"numberOfReferences":100000,"price":15,"product":"pull","traceability":false},"scope":"textile"},{"category":"Pull","id":"f02b1029-0d04-4239-94d1-b384ab3316cb","name":"Pull coton (550g) - Chine - Mode \\"fast fashion\\"","query":{"business":"large-business-without-services","countryDyeing":"CN","countryFabric":"CN","countryMaking":"CN","countrySpinning":"CN","mass":0.55,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":9000,"price":30,"product":"pull","traceability":false},"scope":"textile"},{"category":"Pull","id":"c605e8cc-7f3e-42b6-afc1-9358bda9a633","name":"Pull viscose (550g) - Chine - Mode \\"fast fashion\\"","query":{"business":"large-business-without-services","countryDyeing":"CN","countryFabric":"CN","countryMaking":"CN","countrySpinning":"CN","mass":0.55,"materials":[{"id":"ei-viscose","share":0.7},{"id":"ei-pet","share":0.3}],"numberOfReferences":9000,"price":30,"product":"pull","traceability":false},"scope":"textile"},{"category":"Pull","id":"9986e023-47f7-42c7-8c1b-4fe1371f2f59","name":"Pull coton (550g) - Pakistan - Mode \\"traditionnelle\\"","query":{"business":"large-business-without-services","countryDyeing":"PK","countryFabric":"PK","countryMaking":"PK","countrySpinning":"PK","mass":0.55,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":2500,"price":70,"product":"pull","traceability":false},"scope":"textile"},{"category":"Pull","id":"dc4a1762-ac99-4d41-8ef6-1f4d647dec62","name":"Pull coton bio (550g) - France - Mode \\"traditionnelle\\"","query":{"business":"large-business-with-services","countryDyeing":"FR","countryFabric":"FR","countryMaking":"FR","countrySpinning":"IN","mass":0.55,"materials":[{"id":"ei-coton-organic","share":1}],"numberOfReferences":2500,"price":70,"product":"pull","traceability":true},"scope":"textile"},{"category":"Pull","id":"8a57688b-1da6-4fc4-85aa-a27c6cdf4a56","name":"Pull laine (550g) - France - Mode \\"éthique\\"","query":{"business":"small-business","countryDyeing":"FR","countryFabric":"FR","countryMaking":"FR","countrySpinning":"CN","mass":0.55,"materials":[{"id":"ei-laine-par-defaut","share":1}],"numberOfReferences":200,"price":95,"product":"pull","traceability":true},"scope":"textile"},{"category":"Pull","id":"611fd763-8df3-40d1-a51a-e8073bb3aaf0","name":"Pull laine paysanne (550g) - France - Mode \\"éthique\\"","query":{"business":"small-business","countryDyeing":"FR","countryFabric":"FR","countryMaking":"FR","countrySpinning":"FR","mass":0.55,"materials":[{"country":"FR","id":"ei-laine-nouvelle-filiere","share":1}],"numberOfReferences":200,"price":95,"product":"pull","traceability":true},"scope":"textile"},{"category":"Tshirt / Polo","id":"64ec2a97-5b87-4dc8-a9c2-96f3b50e9fe2","name":"Tshirt synthétique (150g) - Asie - Mode \\"ultra fast fashion\\"","query":{"business":"large-business-without-services","countryDyeing":"RAS","countryFabric":"RAS","countryMaking":"RAS","countrySpinning":"RAS","mass":0.15,"materials":[{"id":"ei-pet","share":0.95},{"id":"ei-pp","share":0.05}],"numberOfReferences":100000,"price":10,"product":"tshirt","traceability":false},"scope":"textile"},{"category":"Tshirt / Polo","id":"351d73dc-9c50-4aa8-858a-2bd5448d1f26","name":"Tshirt coton (150g) - Chine - Mode \\"fast fashion\\"","query":{"business":"large-business-without-services","countryDyeing":"CN","countryFabric":"CN","countryMaking":"CN","countrySpinning":"CN","mass":0.15,"materials":[{"id":"ei-coton","share":0.75},{"id":"coton-rdp","share":0.25}],"numberOfReferences":9000,"price":20,"product":"tshirt","traceability":false},"scope":"textile"},{"category":"Tshirt / Polo","id":"16c16705-3169-41bf-b1b2-6382b00c2118","name":"Tshirt coton (150g) - Pakistan - Mode \\"traditionnelle\\"","query":{"business":"large-business-with-services","countryDyeing":"PK","countryFabric":"PK","countryMaking":"PK","countrySpinning":"PK","mass":0.15,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":2500,"price":30,"product":"tshirt","traceability":false},"scope":"textile"},{"category":"Tshirt / Polo","id":"5dbb2cfb-dc3a-48cc-bc7b-aaefbc3cc285","name":"Tshirt coton (150g) - France - Mode \\"traditionnelle\\"","query":{"business":"large-business-with-services","countryDyeing":"FR","countryFabric":"FR","countryMaking":"FR","countrySpinning":"TR","mass":0.15,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":2500,"price":30,"product":"tshirt","traceability":false},"scope":"textile"},{"category":"Jupe / Robe","id":"307b3586-41f4-4d93-833a-e03b5be137cc","name":"Jupe coton (300g) - Majorant par défaut","query":{"countrySpinning":"CN","mass":0.3,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":15,"product":"jupe","trims":[{"id":"0e8ea799-9b06-490c-a925-37564746c454","quantity":1},{"id":"d56bb0d5-7999-4b8b-b076-94d79099b56a","quantity":1}]},"scope":"textile"},{"category":"Chemise","id":"536e3785-039a-49d6-a119-3cfce485420c","name":"Chemise coton (250g) - Majorant par défaut","query":{"countrySpinning":"CN","mass":0.25,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":15,"product":"chemise","trims":[{"id":"d56bb0d5-7999-4b8b-b076-94d79099b56a","quantity":10}]},"scope":"textile"},{"category":"Jean","id":"bf24fd40-9a2a-4489-935b-d82c339e5abe","name":"Jean coton (450g) - Majorant par défaut","query":{"countrySpinning":"CN","fading":true,"mass":0.45,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":20,"product":"jean","trims":[{"id":"0c903fc7-279b-4375-8cfa-ca8133b8e973","quantity":1},{"id":"0e8ea799-9b06-490c-a925-37564746c454","quantity":1}]},"scope":"textile"},{"category":"Pantalon","id":"f86835d3-7018-40fa-8144-2d1f6aa264b9","name":"Pantalon coton (450g) - Majorant par défaut","query":{"countrySpinning":"CN","mass":0.45,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":20,"product":"pantalon","trims":[{"id":"0c903fc7-279b-4375-8cfa-ca8133b8e973","quantity":1},{"id":"0e8ea799-9b06-490c-a925-37564746c454","quantity":1}]},"scope":"textile"},{"category":"Manteau / Veste","id":"32c8973b-864f-4060-977d-a0738f6414c4","name":"Manteau coton (950g) - Majorant par défaut","query":{"countrySpinning":"CN","mass":0.95,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":40,"product":"manteau","trims":[{"id":"86b877ff-0d59-482f-bb34-3ff306b07496","quantity":1},{"id":"d56bb0d5-7999-4b8b-b076-94d79099b56a","quantity":3}]},"scope":"textile"},{"category":"Tshirt / Polo","id":"f48d7a6b-68db-4d1c-9623-6ec0ab89cbdb","name":"Tshirt coton (150g) - Majorant par défaut","query":{"business":"large-business-without-services","countrySpinning":"CN","mass":0.15,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":10,"product":"tshirt","traceability":false},"scope":"textile"},{"category":"Tshirt / Polo","id":"6a2da9ff-9120-4a47-91ad-a8e72be45f4a","name":"Tshirt coton (150g) - Remanufacturé","query":{"business":"small-business","mass":0.15,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":200,"price":30,"product":"tshirt","traceability":true,"upcycled":true},"scope":"textile"},{"category":"Pull","id":"190ccaed-6883-4dd9-a70b-918878ccced6","name":"Pull coton (550g) - Majorant par défaut","query":{"business":"large-business-without-services","countrySpinning":"CN","mass":0.55,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":15,"product":"pull","traceability":false},"scope":"textile"},{"category":"Chaussettes","id":"47f8d396-9f57-4a1d-8d24-b2fc3439e75f","name":"Chaussettes coton (40g) - Majorant par défaut","query":{"business":"large-business-without-services","countrySpinning":"CN","mass":0.04,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":4,"product":"chaussettes","traceability":false},"scope":"textile"},{"category":"Caleçon (tissé)","id":"3f3be8b2-115b-41b4-b925-5656aa7d8c87","name":"Caleçon coton (40g) - Majorant par défaut","query":{"business":"large-business-without-services","countrySpinning":"CN","mass":0.04,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":4,"product":"calecon","traceability":false},"scope":"textile"},{"category":"Boxer / slip (tricoté)","id":"69a21510-b23b-4910-9bd9-23507c8f5a59","name":"Slip coton (30g) - Majorant par défaut","query":{"business":"large-business-without-services","countrySpinning":"CN","mass":0.03,"materials":[{"id":"ei-coton","share":1}],"numberOfReferences":100000,"price":4,"product":"slip","traceability":false},"scope":"textile"},{"category":"Maillot de bain","id":"9d382f50-f77a-44cd-b26f-702c4a2ceb50","name":"Maillot de bain polyester (100g) - Majorant par défaut","query":{"business":"large-business-without-services","countrySpinning":"CN","mass":0.1,"materials":[{"id":"ei-pet","share":1}],"numberOfReferences":100000,"price":15,"product":"maillot-de-bain","traceability":false},"scope":"textile"}]';
var $author$project$Static$Json$textileProductsJson = '[{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":15,"repairCost":10,"traceability":false},"endOfLife":{"volume":0.006},"fabric":"weaving","id":"chemise","making":{"complexity":"low","pcrWaste":0.2},"name":"Chemise","surfaceMass":200,"trims":[{"id":"d56bb0d5-7999-4b8b-b076-94d79099b56a","quantity":10}],"use":{"daysOfWear":40,"defaultNbCycles":20,"ironingElecInMJ":0.1638,"nonIroningProcessUuid":"163e6de6-9f3f-588c-af3a-7b375438180f","ratioDryer":0.12,"ratioIroning":0.7,"timeIroning":0.043,"wearsPerCycle":2},"yarnSize":40},{"dyeing":{"defaultMedium":"yarn"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":20,"repairCost":14,"traceability":false},"endOfLife":{"volume":0.004},"fabric":"weaving","id":"jean","making":{"complexity":"medium","pcrWaste":0.22},"name":"Jean","surfaceMass":250,"trims":[{"id":"0c903fc7-279b-4375-8cfa-ca8133b8e973","quantity":1},{"id":"0e8ea799-9b06-490c-a925-37564746c454","quantity":1}],"use":{"daysOfWear":70,"defaultNbCycles":23,"ironingElecInMJ":0.24381,"nonIroningProcessUuid":"cefc9a3c-1bb2-50a4-a3ce-f56b891f764a","ratioDryer":0.3,"ratioIroning":0.63,"timeIroning":0.072,"wearsPerCycle":3},"yarnSize":40},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":15,"repairCost":19,"traceability":false},"endOfLife":{"volume":0.007},"fabric":"weaving","id":"jupe","making":{"complexity":"low","pcrWaste":0.2},"name":"Jupe / Robe","surfaceMass":200,"trims":[{"id":"0e8ea799-9b06-490c-a925-37564746c454","quantity":1},{"id":"d56bb0d5-7999-4b8b-b076-94d79099b56a","quantity":1}],"use":{"daysOfWear":70,"defaultNbCycles":23,"ironingElecInMJ":0.0729,"nonIroningProcessUuid":"5ca66e62-356c-57ea-81e9-82951cb7f473","ratioDryer":0.12,"ratioIroning":0.18,"timeIroning":0.075,"wearsPerCycle":3},"yarnSize":40},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":40,"repairCost":31,"traceability":false},"endOfLife":{"volume":0.015},"fabric":"weaving","id":"manteau","making":{"complexity":"high","pcrWaste":0.2},"name":"Manteau / Veste","surfaceMass":450,"trims":[{"id":"d56bb0d5-7999-4b8b-b076-94d79099b56a","quantity":3},{"id":"86b877ff-0d59-482f-bb34-3ff306b07496","quantity":1}],"use":{"daysOfWear":100,"defaultNbCycles":5,"ironingElecInMJ":0.018,"nonIroningProcessUuid":"8f3de83a-4545-528e-83d6-e6a065696394","ratioDryer":0.25,"ratioIroning":0.05,"timeIroning":0.067,"wearsPerCycle":20},"yarnSize":30},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":20,"repairCost":14,"traceability":false},"endOfLife":{"volume":0.004},"fabric":"weaving","id":"pantalon","making":{"complexity":"medium","pcrWaste":0.2},"name":"Pantalon / Short","surfaceMass":250,"trims":[{"id":"0c903fc7-279b-4375-8cfa-ca8133b8e973","quantity":1},{"id":"0e8ea799-9b06-490c-a925-37564746c454","quantity":1}],"use":{"daysOfWear":70,"defaultNbCycles":23,"ironingElecInMJ":0.24381,"nonIroningProcessUuid":"f38c0b5f-873c-5d98-b216-4bf66c5bc520","ratioDryer":0.3,"ratioIroning":0.63,"timeIroning":0.072,"wearsPerCycle":3},"yarnSize":40},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":20,"repairCost":15,"traceability":false},"endOfLife":{"volume":0.0102},"fabric":"knitting-mix","id":"pull","making":{"complexity":"low","pcrWaste":0.2},"name":"Pull","surfaceMass":250,"trims":[],"use":{"daysOfWear":85,"defaultNbCycles":17,"ironingElecInMJ":0,"nonIroningProcessUuid":"a9ed30ef-4849-586f-98be-0c356054947e","ratioDryer":0.3,"ratioIroning":0,"timeIroning":0,"wearsPerCycle":5},"yarnSize":35},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":10,"repairCost":10,"traceability":false},"endOfLife":{"volume":0.0018},"fabric":"knitting-mix","id":"tshirt","making":{"complexity":"low","pcrWaste":0.15},"name":"T-shirt / Polo","surfaceMass":200,"trims":[],"use":{"daysOfWear":45,"defaultNbCycles":45,"ironingElecInMJ":0.0936,"nonIroningProcessUuid":"56a3b3e0-df9f-570b-b656-dab6724ab70c","ratioDryer":0.3,"ratioIroning":0.4,"timeIroning":0.043,"wearsPerCycle":1},"yarnSize":40},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":4,"repairCost":9,"traceability":false},"endOfLife":{"volume":0.002},"fabric":"knitting-fully-fashioned","id":"chaussettes","making":{"complexity":"very-low","pcrWaste":0.02},"name":"Chaussettes","surfaceMass":250,"trims":[],"use":{"daysOfWear":50,"defaultNbCycles":25,"ironingElecInMJ":0,"nonIroningProcessUuid":"a9ed30ef-4849-586f-98be-0c356054947e","ratioDryer":0.3,"ratioIroning":0,"timeIroning":0,"wearsPerCycle":2},"yarnSize":35},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":4,"repairCost":9,"traceability":false},"endOfLife":{"volume":0.002},"fabric":"weaving","id":"calecon","making":{"complexity":"low","pcrWaste":0.15},"name":"Caleçon (tissé)","surfaceMass":180,"trims":[],"use":{"daysOfWear":60,"defaultNbCycles":60,"ironingElecInMJ":0,"nonIroningProcessUuid":"a9ed30ef-4849-586f-98be-0c356054947e","ratioDryer":0.3,"ratioIroning":0,"timeIroning":0,"wearsPerCycle":1},"yarnSize":45},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":4,"repairCost":9,"traceability":false},"endOfLife":{"volume":0.002},"fabric":"knitting-mix","id":"slip","making":{"complexity":"low","pcrWaste":0.15},"name":"Boxer / Slip (tricoté)","surfaceMass":180,"trims":[],"use":{"daysOfWear":60,"defaultNbCycles":60,"ironingElecInMJ":0,"nonIroningProcessUuid":"a9ed30ef-4849-586f-98be-0c356054947e","ratioDryer":0.3,"ratioIroning":0,"timeIroning":0,"wearsPerCycle":1},"yarnSize":45},{"dyeing":{"defaultMedium":"fabric"},"economics":{"business":"large-business-without-services","numberOfReferences":100000,"price":15,"repairCost":9,"traceability":false},"endOfLife":{"volume":0.004},"fabric":"knitting-mix","id":"maillot-de-bain","making":{"complexity":"low","pcrWaste":0.15},"name":"Maillot de bain","surfaceMass":220,"trims":[],"use":{"daysOfWear":30,"defaultNbCycles":30,"ironingElecInMJ":0,"nonIroningProcessUuid":"a9ed30ef-4849-586f-98be-0c356054947e","ratioDryer":0.3,"ratioIroning":0,"timeIroning":0,"wearsPerCycle":1},"yarnSize":40}]';
