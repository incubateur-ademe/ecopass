    ...
    <>
      {organization.type !== OrganizationType.Consultancy && organization.authorizedOrganizations.length > 0 && (
        <Table
          ...
          headers={["Nom", "Nom d'usage", "SIRET", "Etat", "Références", "Dernière date de dépot", "Détails"]}
      ...
      {brands.length > 0 && (
        <div className={classNames("fr-table fr-table--layout-fixed", tableStyles.table)}>
          <table>
            ...
            <thead>
              <tr>
                ...
                <th scope='col'>Dernière date de dépot</th>
