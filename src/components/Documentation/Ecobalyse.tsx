  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <b>Remanufacturé</b> : est ce que le produit est remanufacturé ? true/false.
        </li>
        <li>
          <b>Nombre de références</b> : nombre de références au catalogue de la marque (min : 1, max : 999999).
        </li>
        <li>
          <b>Prix (en euros, TTC)</b> : prix du produit, en Euros (€), TTC (min : 1, max : 1000).
        </li>
        <li>
        ...
        <li>
          <b>Traçabilité géographique</b> : Traçabilité renforcée ? true/false.
        </li>
        <li>
