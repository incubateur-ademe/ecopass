    ...
    <div id='default'>
      <Table
        ...
        data={[
          ...
          [ProductCategory.Jean, "1 bouton en métal, 1 zip court", "20€", Business.WithoutServices, "100 000"],
          [ProductCategory.JupeRobe, "1 zip court, 1 bouton en plastique", "15€", Business.WithoutServices, "100 000"],
          [ProductCategory.MaillotDeBain, "1 bouton en plastique", "15€", Business.WithoutServices, "100 000"],
          [
            ProductCategory.ManteauVeste,
            "5 boutons en plastique, 1 zip long",
            "40€",
            Business.WithoutServices,
            "100 000",
          ],
          [ProductCategory.PantalonShort, "1 bouton en métal, 1 zip court", "20€", Business.WithoutServices, "100 000"],
