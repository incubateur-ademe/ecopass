  ...
  return (
    <>
      <div className={styles.box}>
        <h3>{test ? "Avec ProConnect de test" : "Avec mon accès ProConnect"}</h3>
        {!test && (
          ...
          tabs={[
            {
              ...
              content: (
                <>
                  ...
                  <p className={styles.description}>
                    Vous n’avez pas de SIRET ou/et pas de compte France connect, remplissez ce formulaire pour fournir
                    les pièces nécessaires à la création de votre espace.
                  </p>
                  <Button
