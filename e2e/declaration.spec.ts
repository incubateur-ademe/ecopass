...
test("declare my products", async ({ page }) => {
  ...
  expect(csvContent).toEqual(
    `Référence interne,Score,Erreur\n1234567891000,,"Marque invalide. Voici la liste de vos marques : ""Emmaus"", ""Emmaus Solidarité"", ""Emmaus Connect"""\n1234567891002,,"Catégorie de produit invalide, Origine de l'ennoblissement/impression invalide, Origine de tissage/tricotage invalide, Origine de confection invalide, Origine de filature invalide, Type d'impression invalide, Type de matière invalide, Type de matière invalide, Type d'accessoire invalide"\nREF-123,2318,\n1234567891001,,"Origine de l'ennoblissement/impression invalide, Origine de tissage/tricotage invalide, Origine de confection invalide"\nREF-124,6712,\n1234567891003,,"Le score doit être un nombre positif, La part de transport aérien doit être un pourcentage, Le poids est obligatoire, Le nombre de références doit être un nombre, Le prix doit être un nombre, Le pourcentage d'impression doit être un pourcentage, La part de la matière doit être un pourcentage, La part de la matière doit être un pourcentage, La quantité de l'accessoire doit être un nombre"\n1234567891004,,"Remanufacturé doit valoir 'Oui' ou 'Non', Délavage doit valoir 'Oui' ou 'Non'"\n1234567891006,,"Origine de l'ennoblissement/impression invalide, Origine de tissage/tricotage invalide, Origine de confection invalide, La somme des parts de matières doit être égale à 100%"\n1234567891005,,"Origine de l'ennoblissement/impression invalide, Origine de tissage/tricotage invalide, Origine de confection invalide"\n1234567891007,,Le score déclaré (2221) ne correspond pas au score calculé (2318.326247789541)\nREF-125,1265,\n1234567891008,,"La masse doit être supérieure à 0,01 kg, Origine de l'ennoblissement/impression invalide, Origine de tissage/tricotage invalide, Origine de confection invalide"\n1234567891009,,"La part de transport aérien doit être inférieure à 100%, Le nombre de références doit être inférieur à 999 999, Le prix doit être inférieur à 1000 €, Origine de l'ennoblissement/impression invalide, Origine de tissage/tricotage invalide, Origine de confection invalide, Le pourcentage d'impression doit être inférieur à 80%, La part de la matière doit être inférieure à 100%, La somme des parts de matières doit être égale à 100%"\n`,
  )
